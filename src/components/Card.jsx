...
function Card({ items }) {
    console.log('from card componets', items)
    return (
                ...
                <div className='grid gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 pt-5'>
                    {items.map((item) => (
                        <Link to={'/details'}
                            ...
                            <div key={item.id} style={{ borderWidth: '1px', borderColor: 'lightgray' }}
                            ...
                            >
                                ...
                                <div className='w-full flex justify-center p-2 overflow-hidden'>
                                    <img
                                        ...
                                        src={item.imageUrl || 'https://placehold.co/300x200'} alt={item.title} />
